...
opt = 0.01992434127;
semilogy(infos1_prox2_saga_4.iter(1: 3: 350)*500/8124, infos1_prox2_saga_4.cost(1: 3: 350) - opt, 'k-', 'LineWidth', 1 )
hold on
...
subplot(4, 2, 3)
opt = 0.010782009776;
semilogy(infos1_prox2_saga_5.iter(1: 3: 200)*2000/8124, infos1_prox2_saga_5.cost(1: 3: 200) - opt, 'k-', 'LineWidth', 1)
hold on
opt = 0.01078200944;
...
opt = 0.008854911;
semilogy(infos1_prox2_saga_6.iter(1: 3: 350)*2000/8124, infos1_prox2_saga_6.cost(1: 3: 350) - opt, 'k-', 'LineWidth', 1)
hold on
opt = 0.008854911;
...
semilogy(infos2_prox2_saga_6_5.iter(1: 150)*4000/24692, infos2_prox2_saga_6_5.cost(1: 150) - opt, 'k-', 'LineWidth', 1)
hold on
...
line(1) = semilogy(infos2_prox2_saga_5.iter(1: 200)*4000/24692, infos2_prox2_saga_5.cost(1: 200) - opt, 'k-', 'LineWidth', 1);
hold on
...
semilogy(infos2_prox2_saga_6.iter(1: 3: 350)*4000/24692, infos2_prox2_saga_6.cost(1: 3: 350) - opt, 'k-', 'LineWidth', 1)
hold on
