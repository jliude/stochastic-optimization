...
opt = 0.0085672005246;
semilogy(infos1_DR_prox2_saga_0.iter(1: 3: 350)*2000/8124, infos1_DR_prox2_saga_0.cost(1: 3: 350) - opt, 'k-', 'LineWidth', 1)
hold on 
semilogy(infos1_saga_0.iter(1: 3: 350)*2000/8124, infos1_saga_0.cost(1: 3: 350) - opt, 'g--', 'LineWidth', 1)
hold on
semilogy(infos1_sgd_0.iter(1 :3: 350)*2000/8124, infos1_sgd_0.cost(1: 3: 350) - opt, 'b:', 'LineWidth', 1)
hold on
...
xlabel('epoch')
ylabel('objective gap')
title('mushrooms, \lambda_2 = 0', 'FontSize', 10)
% legend('sdca', 'acc\_sdca', 'saga', 'sgd', 'prox2\_saga')
hold off
...
opt = 0.129213530000;
semilogy(infos2_DR_prox2_saga_0.iter(1: 3: 350)*4000/24692, infos2_DR_prox2_saga_0.cost(1: 3: 350) - opt, 'k-', 'LineWidth', 1)
hold on 
semilogy(infos2_saga_0.iter(1: 3: 350)*4000/24692, infos2_saga_0.cost(1: 3: 350) - opt, 'g--', 'LineWidth', 1)
hold on
semilogy(infos2_sgd_0.iter(1 :3: 350)*4000/24692, infos2_sgd_0.cost(1: 3: 350) - opt, 'b:', 'LineWidth', 1)
hold on
...
xlabel('epoch')
ylabel('objective gap')
title('w7a, \lambda_2=0', 'FontSize', 10)
hold off
